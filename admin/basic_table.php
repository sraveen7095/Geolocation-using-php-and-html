  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> Tours</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-table"></i>Tours</li>
              <li><i class="fa fa-th-list"></i>Add Tours</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <form method="post" enctype="multipart/form-data"  action="basic_table.php">
                <tbody>
                  <tr>
                    <th><i class="icon_profile"></i> Image</th>
                    <th><i class="icon_calendar"></i> Tour id</th>
                    <th><i class="icon_mail_alt"></i> Tour name</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                          ...
                          <input type="submit" class="btn btn-success" name="upload" value="Add"  style="margin-right: 5px;">
