            ...
            <div class="profile-widget profile-widget-info">
              <div class="panel-body">
                ...
                <div class="col-lg-4 col-sm-4 follow-info">
                  <p>Hello I’m Shane Sraveen, a leading expert in interactive and creative design.</p>
                  <p>@sraveenvirat</p>
                  <p><i class="fa fa-twitter">sraveenvirat</i></p>
                  <h6>
                ...
                <div class="col-lg-2 col-sm-6 follow-info weather-category">
                  <ul>
                    <li class="active">
                      ...
                      <i class="fa fa-comments fa-2x"> </i><br> Comments are to be done here.
                    </li>
                ...
                <div class="col-lg-2 col-sm-6 follow-info weather-category">
                  <ul>
                    <li class="active">
                      ...
                      <i class="fa fa-bell fa-2x"> </i><br> Notifications
                    </li>
                  ...
                  <div id="profile" class="tab-pane">
                    <section class="panel">
                      <div class="bio-graph-heading">
                        Hello I’m Shane Sraveen, a leading expert in interactive and creative design specializing in the mobile medium. My graduation from Massey University with a Bachelor of Design majoring in visual communication.
                      </div>
                      <div class="panel-body bio-graph-info">
                        <h1>Bio Graph</h1>
                        <div class="row">
                          <div class="bio-row">
                            <p><span>First Name </span>:Shane </p>
                          </div>
                          <div class="bio-row">
                            <p><span>Last Name </span>:Sraveen</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Birthday</span>:17-october-1998</p>
                          </div>
                          <div class="bio-row">
                          ...
                          <div class="bio-row">
                            <p><span>Email </span>:sraveenvirat@gmail.com</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Mobile </span>:+919515722622</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Phone </span>:+918790147686</p>
                          </div>
                        </div>
                      </div>
                    </section>
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <form class="form-horizontal" role="form">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="url" placeholder="http://www.travelandtourismguide.com ">
                            </div>
                          </div>
